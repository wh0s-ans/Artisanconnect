...
export default function AdminStats() {
 ...
 <h1 className="text-2xl sm:text-3xl lg:text-5xl font-semibold text-editorial-fg ">Rapports & Statistiques</h1>
 </div>
 ...
 <h3 className="text-sm font-semibold">Volume de transactions</h3>
 </div>
 ...
 <h3 className="text-sm font-semibold">Taux de conversion (Devis)</h3>
 </div>
 ...
 <div className="flex items-center gap-3 text-editorial-muted mb-6">
 <Activity className="h-5 w-5" />
 <h3 className="text-sm font-semibold">Nouveaux Artisans</h3>
 </div>
 ...
 <p className="text-editorial-muted text-xl">Interface graphique de données en cours d'intégration</p>
 <p className="text-sm font-medium text-editorial-muted/70 font-bold mt-4">Module Recharts prévu</p>
 </div>
 </div>
 </div>
 );
